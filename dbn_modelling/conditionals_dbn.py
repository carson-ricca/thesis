...
def conditionals():
    ...
    decision_diagrams_cpd = TabularCPD(decision_diagrams_node_0, 2, [
        [0.9, 0.7, 0.6, 0.2],
        [0.1, 0.3, 0.4, 0.8]
    ], [conditionals_node_0, boolean_expressions_node_0], [2, 2])
    ...
    ], [conditionals_node_0, decision_diagrams_node_0, relational_and_logical_operators_node_0,
                 boolean_expressions_node_0], [2, 2, 2, 2])

    nested_conditional_statements_cpd = TabularCPD(nested_conditional_statements_node_0, 2, [
        [0.9, 0.4, 0.7, 0.2],
        [0.1, 0.6, 0.3, 0.8]
    ], [conditionals_node_0, conditional_statements_node_0], [2, 2])
    ...
    ], [conditionals_node_0, nested_conditional_statements_node_0, simple_programs_node_0],
                              [2, 2, 2])
    ...
    boolean_expressions_transitional_cpd = TabularCPD(boolean_expressions_node_1, 2, [
        [0.9, 0.7, 0.6, 0.1],
        [0.1, 0.3, 0.4, 0.9]
    ], [boolean_expressions_node_0, conditionals_node_1], [2, 2])
    ...
    ], [decision_diagrams_node_0, conditionals_node_1, boolean_expressions_node_1], [2, 2, 2])

    relational_and_logical_operators_transitional_cpd = TabularCPD(relational_and_logical_operators_node_1, 2, [
        [0.9, 0.8, 0.8, 0.8, 0.8, 0.6, 0.6, 0.1],
        [0.1, 0.2, 0.2, 0.2, 0.2, 0.4, 0.4, 0.9]
    ], [relational_and_logical_operators_node_0, conditionals_node_1, boolean_expressions_node_1],
                                                                   [2, 2, 2])
    ...
    ], [conditional_statements_node_0, conditionals_node_1, decision_diagrams_node_1,
                 relational_and_logical_operators_node_1, boolean_expressions_node_1], [2, 2, 2, 2, 2])

    nested_conditional_statements_transitional_cpd = TabularCPD(nested_conditional_statements_node_1, 2, [
        [0.9, 0.8, 0.8, 0.8, 0.8, 0.6, 0.6, 0.1],
        [0.1, 0.2, 0.2, 0.2, 0.2, 0.4, 0.4, 0.9]
    ], [nested_conditional_statements_node_0, conditionals_node_1, conditional_statements_node_1],
                                                                [2, 2, 2])

    simple_programs_transitional_cpd = TabularCPD(simple_programs_node_1, 2, [
        [0.9, 0.8, 0.8, 0.8, 0.8, 0.6, 0.6, 0.1],
        [0.1, 0.2, 0.2, 0.2, 0.2, 0.4, 0.4, 0.9]
    ], [simple_programs_node_0, conditionals_node_1, conditional_statements_node_1], [2, 2, 2])
    ...
    ], [programs_node_0, conditionals_node_1, nested_conditional_statements_node_1, simple_programs_node_1],
                                           [2, 2, 2, 2])
